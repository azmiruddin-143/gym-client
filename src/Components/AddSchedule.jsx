...
const AddSchedule = () => {
    ...
    const addSchedule = (e) => {
        ...
        const scheduleObj = {title,selecteddate, isComplete: false,  selectedday, selectedtime}
    ...
    return (
        <div className='mx-28 my-10'>
            <form onSubmit={addSchedule} action="">
                ...
                <div className='w-full'>
                    <button className='bg-[#1d7fb4] text-white font-bold w-full py-2 px-3 my-5 rounded-lg'>Add Schedule</button>
                </div>
            </form>
        </div>
    );
